...
import TriggerTimerCreateForm from 'components/TriggerTimerCreateForm';
import { FormattedMessage } from 'react-intl';
import commonMessages from 'messages';
import messages from './messages';
import Item from './item';

class TriggerTimerForm extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    ...
    return (
      <div>
        ...
        <TriggerTimerCreateForm onCreate={onCreate} />
      </div>
    );
  }
}

TriggerTimerForm.propTypes = {
  triggers: React.PropTypes.array,
  onRemove: React.PropTypes.func,
  onCreate: React.PropTypes.func,
};

export default TriggerTimerForm;
